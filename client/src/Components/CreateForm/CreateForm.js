...
const createFormStates = {
    CREATE_FORM_STATE_ERROR: 'Error',
    CREATE_FORM_STATE_CHECKING_BALANCE: 'Checking balance',
    CREATE_FORM_STATE_CHECKING_ALLOWANCE: 'Checking allowance',
    CREATE_FORM_STATE_WAITING_ALLOWANCE: 'Waiting for allowance',
    CREATE_FORM_STATE_WAITING_STREAM: 'Waiting for stream creation',
    CREATE_FORM_STATE_FINISHED: 'Finished'
}

const CreateForm = ({web3, sender, tokenInstance, amount, sealedSablierInstance, recipient, duration}) => {
